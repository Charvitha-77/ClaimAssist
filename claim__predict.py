...
filename = "C:/Users/Charvitha Reddy/Downloads/team_24/claim_model_bundle.pkl"
model_bundle = pickle.load(open(filename, 'rb'))

# Extract components from the bundle
loaded_model = model_bundle['model']
scaler = model_bundle['scaler']
jobtitle_le = model_bundle['le_job_title']
hereditary_disease_le = model_bundle['le_hereditary_diseases']
city_le = model_bundle['le_city']
